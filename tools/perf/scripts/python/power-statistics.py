...
def parse_args():
    ...
    parser.add_argument(
        ...
        const='idle-cluster',
        nargs='?',
        choices=['idle-cluster', 'task', 'timer', 'frequency', 'summary', 'all'],
        help=
        "idle-cluster, timer or task or all FIXME",
    )
    parser.add_argument(
        "-C", "--cpu",
        default=None,
...
def trace_begin():
    global ej, mode_timer, mode_cluster, mode_task, mode_frequency
    args = parse_args()
